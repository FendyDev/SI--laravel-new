         ...
         <div class="container">
            <div class="flex flex-wrap ">
               <div class="w-full self-center px-4 lg:w-1/2">
                  ...
                  <p class="font-medium text-slate-100 mb-10 leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam quo voluptas perspiciatis a iusto fuga! Atque cum maiores
                      inventore tempora reprehenderit sequi, omnis quo ipsum doloremque et accusantium iste veritatis!</p>
               ...
               <div class="w-full self-end px-4 lg:w-1/2">
                  <div class="mt-10">
                     <img src="img/smk2.png" alt="smklog" class="max-w-full mx-auto">
                  </div>
               </div>
            </div>
         </div>
