...
@section('container')
    <div class="container px-2">
        ...
        @foreach ($admin as $new)
            <div class="modal fade" id="edit-{{ $new->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content text-white bg-dark ">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Ubah Akun Admin</h1>
                        </div>
                        <div class="modal-body text-white bg-dark ">
                                ...
                                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mb-3">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="text" name="role" id="rl"
                                            ...
                                            value="{{ $new->role }}" disabled readonly>
                                    </div>
                                    <div class="w-full">
                                        <label for="disabled-input-2"
                                            class="block mb-2 text-sm font-medium text-white">Role</label>
                                        <input type="text" name="level" id="disabled-input-2"
                                            aria-label="disabled input 2"
                                            class="bg-gray-5 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-600 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            value="Admin" disabled readonly>
                                    </div>
                                </div>
                                <div class="modal-footer mt-3">
        ...
        <div class="relative overflow-x-auto  hidden lg:block">
            <table class="w-full text-sm text-left  rtl:text-right text-gray-500 dark:text-gray-400 stripe"
                id="dt">
