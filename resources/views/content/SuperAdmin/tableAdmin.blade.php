...
@section('container')
        <div class="container px-2">
                        ...
                        <div class="modal-content text-white bg-dark ">
                            ...
                            <div class="modal-body text-white bg-dark ">
                                <form action="{{ route('update', $new->id) }}" method="POST">
                                    ...
                                    <div class="modal-footer mt-3">
                                        <button title="Ubah" type="submit" class="btn btn-success edit">Edit Akun</button>
           ...
           <div class="relative overflow-x-auto  hidden lg:block">
            <table class="w-full text-sm text-left  rtl:text-right text-gray-500 dark:text-gray-400 stripe" id="dt">
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                    <form action="{{ route('delete', $view->id) }}" method="POST">
                                        @if (isset($view->id))
                                            <a title="Ubah" href="{{ route('edit', $view->id) }}"
